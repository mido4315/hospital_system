        ...
        child: Column(
          children: [
            ...
            Row(
              ...
              Container(
                width: 100,height: 35,
                child: ElevatedButton(onPressed:Botton1Pressed, child: Text("Accapt",style: TextStyle(color: Colors.white)),
                style: ElevatedButton.styleFrom(backgroundColor: Colors.green),
                ),
              ),
              Container(
                width: 100,height: 35,
                child: ElevatedButton(onPressed:Botton2Pressed, child: Text("Busy",style: TextStyle(color: Colors.white)),
